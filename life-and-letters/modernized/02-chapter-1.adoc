...
"`My child, you seem very kind to me, a poor creature;
...
which you mention; it being, certainly, preparatory to the work of reformation in us;
...
a fellowship incomprehensible, it is indeed attended with rejoicing of heart.
...
we can adopt the language of the just to their ancient source:
...
a holy fellowship and communion experienced by those whose language is similar and pure,
...
a deep sense of mourning ensued: for from so short, and even from a long friendship,
...
from either the conversation or consolation of a friend.
...
which is imprinted with a sense of the benevolent extendings of divine regard,
...
if we have but an evidence that we have not stepped out of the holy enclosure;
...
For my part, I had deep heartfelt mortification,
...
this offering will be acceptable to the Searcher of hearts; and,
...
but being convinced that there is a better and more refined correspondence than this,
