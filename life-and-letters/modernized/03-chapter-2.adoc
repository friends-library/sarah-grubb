...
and I was making the necessary preparations for proceeding to the next meeting,
...
be engaged to see what it is that keeps you in a state of weakness,
...
and have a steadfast example therein?
